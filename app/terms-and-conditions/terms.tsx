    ...
    <div className="bg-white px-6 py-4 lg:px-8">
      <div className="mx-auto max-w-3xl text-base leading-7 text-gray-700">
        ...
        <section className="my-10">
          <h2 className="text-xl font-semibold">AMENDMENT OF TERMS</h2>
          <p className="mt-2">
        ...
        <section className="my-10">
          ...
          <p className="mt-2">
            ...
            agree and accept that VeloTech.dev is not legally responsible for
            any loss or damage you might suffer related to your use of the
            website, whether from errors or from omissions in our documents or
            information, any goods or services we may offer or from any other
            use of the website. This includes your use or reliance on any third
            party content, links, comments or advertisements. Your use of, or
            reliance on, any information or materials on this website is
          ...
          <p className="mt-2">
            ...
            specific, personal requirements. You acknowledge that such
        ...
        <section className="my-10">
          ...
          <p className="mt-2">
            You must be over 18 years of age to use this website
          </p>
        </section>
        ...
        <section className="my-10">
          ...
          <p className="mt-2">
            ...
            for any advice received in this regard.
          </p>
        </section>
        ...
        <section className="my-10">
          ...
          <p className="mt-2">
            Whilst we, at all times endeavour to have the most accurate,
            reliable and up-to-date information on our website, we do not
            warrant or make any representations regarding the use or the result
            of the use of any document, product, service, link or information in
            its website or as to their correctness, suitability, accuracy,
          ...
          <p className="mt-2">
            ...
            ensure you are aware of any risk you may be taking by using this
            website or any products or services that may be offered through it.
